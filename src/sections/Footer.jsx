...
import { footerLogo } from '../assests/images'
import { footerLinks, socialMedia } from '../constants'
import { copyrightSign } from '../assests/icons'
...
<footer className='max-container'>  
  <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
   <div className='flex flex-col items-start'>
    ...
    <p className='mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm'> Get shoes ready for the new term at your nearest Nike 
      Store.Get Rewards</p>
...
<img src={copyrightSign} alt="copyright" width={20} height={20} className='rounded-full -m-0.5' />
